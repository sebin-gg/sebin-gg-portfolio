...
export function SiteFooter() {
  ...
  return (
    <footer className="border-line border-t">
      <div className="text-ink-soft mx-auto flex w-full max-w-5xl flex-col items-center justify-between gap-4 px-4 py-10 text-sm sm:flex-row sm:px-6">
        <p>
        ...
        <p className="text-ink-faint font-mono text-xs">
          <span className="text-accent">$</span> status → open to work · no telemetry, as it should
          be
        </p>
      </div>
    </footer>
