...
echo "==> Installing Playwright browsers (for e2e + visual checks)"
...
echo "  bash scripts/links.sh  → opens every account/app you still need to enable (Search Console, Bing, ...)"
